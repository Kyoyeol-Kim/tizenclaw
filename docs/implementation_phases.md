...
- **주요 구현 항목**:
  ...
  2. RPM 패키징 시 RootFS 타볼을 `/opt/usr/share/tizenclaw/rootfs.tar.gz` 경로에 포함
...
- **주요 구현 항목**:
  1. Agent Core에서 `/opt/usr/share/tizenclaw/skills/` 폴더 감시 및 매니페스트 읽기 로직 (Prompt Builder 연동)
